<h2><a href="https://leetcode.com/problems/single-row-keyboard/">1165. Single-Row Keyboard</a></h2><h3>Easy</h3><hr><div bis_skin_checked="1"><p>There is a special keyboard with <strong>all keys in a single row</strong>.</p>
